...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calc = function calc(size, material, options, promokod, result) {
  var sizeBlock = document.querySelector(size),
      materialBlock = document.querySelector(material),
      optionsBlock = document.querySelector(options),
      promokodBlock = document.querySelector(promokod),
  ...
  var calcFunc = function calcFunc() {
    ...
    } else if (promokodBlock.value === "IWANTPOPART") {
  ...
  promokodBlock.addEventListener("input", calcFunc);
};
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      item.classList.add("animated", "fadeOutUo");
      setTimeout(function () {
        item.style.display = "none";
      }, 400);
      var statusImg = document.createElement("img");
      statusImg.setAttribute("src", messeage.spinner);
      statusImg.classList.add("animated", "fadeInIp");
      ...
      postData(api, formData).then(function (res) {
        console.log(res);
        statusImg.setAttribute("src", messeage.ok);
        textMessage.textContent = messeage.succes;
      }).catch(function () {
        statusImg.setAttribute("src", messeage.failure);
        textMessage.textContent = messeage.failure;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
...
var mask = function mask(selector) {
  var setCursorPosition = function setCursorPosition(pos, elem) {
    ...
    if (elem.setSelectionRange) {
      ...
      range.collapse(true);
      range.movEnd("character", pos);
      range.movStart("character", pos);
      range.select();
    }
  };
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener("click", function (e) {
        ...
        document.body.style.marginRight = "".concat(scroll, "px"); //   document.body.classList.add("modal-open");  с помощью bootstrap свойство hidden
      });
    });
    close.addEventListener("click", function () {
      ...
      document.body.style.marginRight = "0px"; //   document.body.classList.add("modal-open");  с помощью bootstrap свойство hidden
    });
    modal.addEventListener("click", function (e) {
      if (e.target === modal) {
        ...
        modal.style.display = "none";
        document.body.style.overflow = "";
        document.body.style.marginRight = "0px"; // document.body.classList.remove("modal-open"); с помощью bootstrap свойство hidden
      }
    });
  }
